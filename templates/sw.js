{% cache globally using key 'service-worker' %}	
...
const config = {
	version: 'v{{staticAssetsVersion}}::',
	staticCacheItems: [
		'{{ baseUrl }}assets/css/styles.min.{{staticAssetsVersion}}.css',
		'{{ baseUrl }}assets/js/main.min.{{staticAssetsVersion}}.js',
	],
	cachePathPattern: /^\/(?:(20[0-9]{2}|fonts|css|images|js)\/(.+)?)?$/,
